...
interface CustomerRefHistoryModalProps {
  isOpen: boolean;
  onClose: () => void;
  loading: boolean;
  customer: {
...
export default function CustomerRefHistoryModal({
  isOpen,
  onClose,
  loading,
  customer,
  history,
}: CustomerRefHistoryModalProps) {
  const t = useTranslations('admin.customers.historyModal');
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <p className="text-sm font-medium text-foreground">
                        {formatRef(entry.previousRef)} {t('arrow')}{' '}
                        {formatRef(entry.newRef)}
                      </p>
                    </div>
