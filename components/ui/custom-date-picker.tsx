          ...
          <div className="absolute z-30 mt-2 w-full min-w-[18rem] rounded-site border border-stroke bg-card-bg p-4 shadow-xl">
            <div className="mb-4 flex items-center justify-between gap-3">
              <Button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-stroke text-secondary transition-colors hover:border-primary hover:text-foreground"
              >
                <ChevronLeft
                  size={16}
